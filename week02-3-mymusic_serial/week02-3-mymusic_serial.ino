...
{
  delay(1000);
  Serial.begin(9600); // 地5行程式碼 再arduino
...
void serialEvent(){ //第6行 負責USB的 Serial 的函示
  while (Serial.available()) { //第七行 如果USB 有資料
    Serial.read(); //第八行 就讀進來

...
void keyPressed(){
  if (keyCode==LEFT) { dx = -1; dy = 0; dir = 2; } // dir:2 向左
  if (keyCode==RIGHT){ dx = +1; dy = 0; dir = 0; } // dir:0 向右
  if (keyCode==UP)   { dx = 0; dy = -1; dir = 3; } // dir:3 向上
  if (keyCode==DOWN) { dx = 0; dy = +1; dir = 1; } // dir:1 向下
}
